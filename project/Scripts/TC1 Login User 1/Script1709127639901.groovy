...
//
//def userName = data.getObjectValue('username', 4)
...
WebUI.setText(findTestObject('Object Repository/Login/input_Username_username'), 'Aditya_Farid_Riyan_Wijaya')

WebUI.setText(findTestObject('Object Repository/Login/input_Password_password'), 'user_sauce')
